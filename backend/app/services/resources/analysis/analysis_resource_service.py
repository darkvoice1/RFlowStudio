...
from app.services.resources.analysis.analysis_report_service import (
...
class DatasetAnalysisResourceService:
    """Handle dataset analysis validation, execution, and persistence."""
...
DatasetAnalysisService = DatasetAnalysisResourceService
